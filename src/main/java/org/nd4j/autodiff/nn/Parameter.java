...
public abstract class Parameter extends SDVariable {

    private SDVariable data;
    private INDArray initialArray;
    private boolean requiresGrad = true;

    Parameter(SDVariable data) {
        this.data = data;
    }

    public void requiresGrad(boolean shouldRequire) {
        requiresGrad = shouldRequire;
    }
    ...
    public void setData(SDVariable data) {
        this.data = data;
    }

    // Region: SDVariable Methods
    ...
    @Override
    public SDVariable castTo(DataType dataType) {
        return data.castTo(dataType);
    }

    @Override
    public SDVariable castTo(String name, DataType dataType) {
    ...
    @Override
    public SDVariable mmul(String name, SDVariable other, MMulTranspose mMulTranspose) {
